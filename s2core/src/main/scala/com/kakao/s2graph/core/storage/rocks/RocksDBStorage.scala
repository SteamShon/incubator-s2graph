...
import com.kakao.s2graph.core.storage.serde.snapshotedge.tall.SnapshotEdgeDeserializable
import com.kakao.s2graph.core.storage.serde.{indexedge, snapshotedge}
